...
Version  : 1.9
Release  : 1
URL      : https://cran.r-project.org/src/contrib/tensorflow_1.9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tensorflow_1.9.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1541775728
