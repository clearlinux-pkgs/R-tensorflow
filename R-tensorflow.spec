...
Version  : 2.9.0
Release  : 44
URL      : https://cran.r-project.org/src/contrib/tensorflow_2.9.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tensorflow_2.9.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653347869
